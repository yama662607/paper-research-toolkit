...
|---|---|---|---|
| `slide-creator` | skill | [install/skills/slide-creator.md](install/skills/slide-creator.md) | Create, edit, inspect, and validate PowerPoint .pptx decks, including content-quality planning, native equations, embedded videos, animations, PowerPoint PDF QA, existing-deck ingestion, and safe human-agent round-trip workflows. |

## Stable Release

These guides are prepared for `v0.3.0` from:
